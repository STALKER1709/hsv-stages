            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-slate-400">
                    ...
                    <li class="flex items-center gap-2">
                        ...
                        <a href="{{ \App\Support\WhatsAppLink::make(config('services.contact.whatsapp_number'), 'Bonjour HSV Stages,') }}" target="_blank" rel="noopener" class="hover:text-emerald-400 transition-colors">WhatsApp : {{ config('services.contact.whatsapp_number') }}</a>
                    </li>
